...
| <br>Singapore's Demolished Public Housing Blocks 	| Information about demolished HDB blocks manually collected by researcher Teoalida. HDB does not actively release information about its demolished blocks.  As Teo's data was incomplete, we had to manually impute missing details via additional research and inferential imputation.  	| Adapted from the work of [Teoalida](https://www.teoalida.com/singapore/serslist/#potential-sers-sites) 	| hdb_demo_extensive_21APRIL.csv 	|
